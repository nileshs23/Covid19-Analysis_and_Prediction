...
latest_data = pd.read_csv('https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports/04-25-2021.csv')
us_medical_data = pd.read_csv('https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports_us/04-25-2021.csv')
...
countries = ['US', 'Pakistan', 'India', 'Italy', 'South Africa'] 
...
compare_countries = ['US', 'Pakistan', 'India', 'Italy', 'South Africa'] 
